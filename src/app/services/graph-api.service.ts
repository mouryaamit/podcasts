...
export class GraphApiService {
  ...
  getSumpoornGraphApiDataFromJson() {
    return new Promise((resolve, reject) =>{
      this.apiService.getApi(environment.host + "sumpoorn_api.json?date="+new Date()).then((resp: any) =>{
        resolve(resp);
      },(error) =>{
          reject(error);
      })
  ...
  getSumpoornGraphApiData(data) {
    return new Promise((resolve, reject) =>{
      this.apiService.postApi(environment.swaraHost + "swara-sumpoorn/sump/services/v1/get-sumpoorn-data", data, null).then((resp: any) =>{
        resolve(resp);
      },(error) =>{
          reject(error);
      })
