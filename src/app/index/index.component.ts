import { Component, OnInit, ViewChild, ViewEncapsulation, OnDestroy, AfterViewInit, ElementRef } from '@angular/core';
...
export class IndexComponent implements OnInit,AfterViewInit,OnDestroy {
    ...
    constructor(private graphApiService: GraphApiService, public sumpoornApiService: SumpoornApiService, private router: Router, private elRef: ElementRef) {
     ...
     ngAfterViewInit() {
      ...
      this.observer.observe(div, {
        ...
        childList: true,  // Track child nodes
