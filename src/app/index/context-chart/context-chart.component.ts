...
export class ContextChartComponent implements OnInit {
  ...
  generateMobileContextGraph() {
    ...
    const x1 = d3
      .scaleTime()
      .domain(
        d3.extent(mydata, function (d: any) {
    ...
    const y4 = d3
      .scaleLinear()
      .domain([
        d3.min(dataForGVA, function (d) {
          return d.value - 10;
        }),
        d3.max(dataForGVA, function (d) {
          return d.value + 10;
        }),
      ])
      .nice()
    ...
    const svgY = d3
      .select('#mobile_context_graph_y_axis_svg')
      .append('svg')
      .attr('height', 500)
      .attr('width', 30)
    ...
    const svg = d3
      .select('#mobile_context_graph_svg')
    ...
    const x_axis_months = svg
      ...
      .attr('class', function (d, i) {
        return `x_month_name_context x_month_name_context_${i}`;
      })
    ...
    function initializeTooltip() {
      tooltip = d3
        .select('#mobile_context_graph_svg') // can be body
        .append('div')
    ...
    function refreshYaxisTicks(tickName) {
      if (tickName == 'iip') {
        svgY_iip = d3
          .select('#mobile_context_graph_y_axis_iip_svg')
          .append('svg')
          .attr('height', 500)
          .attr('width', 35)
          .attr('transform', 'translate(-5, 13)');

        yAxis_right_for_iip_tick = svgY_iip
          .append('g')
          .attr('stroke-width', '0')
          .attr('transform', 'translate(24, 6)')
        ...
        svgY_pmi = d3
          .select('#mobile_context_graph_y_axis_pmi_svg')
          .append('svg')
          .attr('height', 500)
          .attr('width', 35)
          .attr('transform', 'translate(-5, 13)');

        yAxis_right_for_pmi_tick = svgY_pmi
          .append('g')
          .attr('stroke-width', '0')
          .attr('transform', 'translate(24, 6)')
        ...
        svgY_gva = d3
          .select('#mobile_context_graph_y_axis_gva_svg')
          .append('svg')
          .attr('height', 500)
          .attr('width', 35)
          .attr('transform', 'translate(-5, 13)');

        yAxis_right_for_gva_tick = svgY_gva
          .append('g')
          .attr('stroke-width', '0')
          .attr('transform', 'translate(24, 6)')
    ...
    var isIipCheckBoxEnabled = $('#IIPCheckboxMob')
        ? $('#IIPCheckboxMob').attr('checked') == 'true'
          ? true
          : false
        : false,
      isPmiCheckBoxEnabled = $('#PMICheckboxMob')
        ? $('#PMICheckboxMob').attr('checked') == 'true'
          ? true
          : false
        : false,
      isGvaCheckBoxEnabled = $('#GVACheckboxMob')
        ? $('#GVACheckboxMob').attr('checked') == 'true'
          ? true
          : false
        : false;
  ...
  generateContextGraph() {
    ...
    const x1 = d3
      ...
      .domain(
        d3.extent(mydata, function (d) {
          return d3.timeParse('%m-%Y')(d.category);
        })
      )
    ...
    const yAxis_right_for_iip = d3.axisRight(y2).tickSize(0);
    const yAxis_right_for_pmi = d3.axisRight(y3);

    const yAxis_right_for_gva = d3.axisRight(y4);

    const svgY = d3
      .select('#context_graph_y_axis_svg')
      .append('svg') //append svg element inside #chart
    ...
    const svgY_gva = d3
      .select('#context_graph_y_axis_gva_svg')
      .append('svg') //append svg element inside #chart
    ...
    const svgY_pmi = d3
      .select('#context_graph_y_axis_pmi_svg')
      .append('svg') //append svg element inside #chart
    ...
    const svgY_iip = d3
      .select('#context_graph_y_axis_iip_svg')
      .append('svg') //append svg element inside #chart
      .attr('width', 35) //set width
      .attr('height', default_height + 30) //set height
      .append('g')
    ...
    const tooltip = d3
      .select('#context_graph_svg') // can be body
      .append('div')
      .attr('class', 'tooltip-area')
      .style('opacity', 0);
    const radiation = d3
    ...
    var isIipCheckBoxEnabled: boolean = $('#IIPCheckbox')
        ? $('#IIPCheckbox').attr('checked') == 'true'
          ? true
          : false
        : false,
      isPmiCheckBoxEnabled: boolean = $('#PMICheckbox')
        ? $('#PMICheckbox').attr('checked')
          ? true
          : false
        : false,
      isGvaCheckBoxEnabled: boolean = $('#GVACheckbox')
        ? $('#GVACheckbox').attr('checked')
          ? true
          : false
        : false;
