...
import 'podcast_copy_model.dart';
export 'podcast_copy_model.dart';

class PodcastCopyWidget extends StatefulWidget {
  const PodcastCopyWidget({
    super.key,
    String? selectedPage,
  ...
  static String routeName = 'PodcastCopy';
  static String routePath = '/podcastCopy';

  @override
  State<PodcastCopyWidget> createState() => _PodcastCopyWidgetState();
}

class _PodcastCopyWidgetState extends State<PodcastCopyWidget> {
  late PodcastCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PodcastCopyModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                Align(
                                  alignment: AlignmentDirectional(0.0, 0.0),
                                  child: wrapWithModel(
                                    model: _model.featuredEpisodeCardModel,
                                    updateCallback: () => safeSetState(() {}),
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        child: Builder(
                                          builder: (context) => wrapWithModel(
                                            model:
                                                _model.shortsBudgetSpecialModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model: _model.shortsTirthankarModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model: _model.shortsSrivatsModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model:
                                              _model.shortsBudgetKrishnanModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model:
                                              _model.shortsBudgetLaveeshModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model: _model.shortsBudgetAnilModel,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model:
                                              _model.shortsZeenatDetails1Model,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model:
                                              _model.shortsZeenatDetails2Model,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                      ...
                                      Container(
                                        child: wrapWithModel(
                                          model:
                                              _model.shortsZeenatDetails3Model,
                                          updateCallback: () =>
                                              safeSetState(() {}),
