...
import 'podcast_details_screen_model.dart';
export 'podcast_details_screen_model.dart';

class PodcastDetailsScreenWidget extends StatefulWidget {
  const PodcastDetailsScreenWidget({
    super.key,
    required this.slug,
  });
  ...
  static String routeName = 'PodcastDetailsScreen';
  static String routePath = '/podcast/:slug';

  @override
  State<PodcastDetailsScreenWidget> createState() =>
      _PodcastDetailsScreenWidgetState();
}

class _PodcastDetailsScreenWidgetState
    extends State<PodcastDetailsScreenWidget> {
  late PodcastDetailsScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PodcastDetailsScreenModel());
                                                                                                ...
                                                                                                SingleChildScrollView(
                                                                                                  ...
                                                                                                  child: Row(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      Container(
                                                                                                        child: wrapWithModel(
                                                                                                          model: _model.shortsBudgetKrishnanModel,
                                                                                                          updateCallback: () => safeSetState(() {}),
                                                                                                      ...
                                                                                                      Container(
                                                                                                        child: wrapWithModel(
                                                                                                          model: _model.shortsBudgetLaveeshModel,
                                                                                                          updateCallback: () => safeSetState(() {}),
                                                                                                      ...
                                                                                                      Container(
                                                                                                        child: wrapWithModel(
                                                                                                          model: _model.shortsBudgetUnniKrishnanModel,
                                                                                                          updateCallback: () => safeSetState(() {}),
                                                                                                            ...
                                                                                                            return GridView.builder(
                                                                                                              ...
                                                                                                              itemBuilder: (context, highlightsGridIndex) {
                                                                                                                ...
                                                                                                                return Padding(
                                                                                                                  ...
                                                                                                                  child: wrapWithModel(
                                                                                                                    model: _model.shortsDynamicModels.getModel(
                                                                ...
                                                                child:
                                                                  ...
                                                                  updateCallback: () =>
                                                                      safeSetState(
                                                                          () {}),
                                                                  child:
                                                                      ExploreEpisodesBudgetWithContainerDynamicWidget(
                                                                    key: Key(
