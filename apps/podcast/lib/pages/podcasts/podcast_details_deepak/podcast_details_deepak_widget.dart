...
import 'podcast_details_deepak_model.dart';
export 'podcast_details_deepak_model.dart';

class PodcastDetailsDeepakWidget extends StatefulWidget {
  ...
  State<PodcastDetailsDeepakWidget> createState() =>
      _PodcastDetailsDeepakWidgetState();
}

class _PodcastDetailsDeepakWidgetState
    extends State<PodcastDetailsDeepakWidget> {
  late PodcastDetailsDeepakModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PodcastDetailsDeepakModel());
                                              ...
                                              child: RichText(
                                                ...
                                                text: TextSpan(
                                                  children: [
                                                    TextSpan(
                                                      text:
                                                          'India\'s economy rarely moves in a single direction — and the October 2024 Sumpoorn Index makes that contradiction vivid. \n\nIn this episode, we unpack a month where the headline composite index dropped, macro indicators stayed soft, two-wheeler sales went through the roof, and the MSME payment crisis deepened to levels that demand urgent national attention.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                                                                        ...
                                                                                        if (_model.selectedIndex == 1) {
                                                                                          ...
                                                                                          return Container(
                                                                                            ...
                                                                                            child: Column(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                wrapWithModel(
                                                                                                  model: _model.deepakTimestampModel1,
                                                                                                  updateCallback: () => safeSetState(() {}),
                                                                                          ...
                                                                                          return Column(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              wrapWithModel(
                                                                                                model: _model.deepakAISummaryModel1,
                                                                                                updateCallback: () => safeSetState(() {}),
                                                                                                child: DeepakAISummaryWidget(),
                                                                                              ),
                                                                                            ],
                                                                                          );
                                                                                        } else {
                                                                                          return Column(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              wrapWithModel(
                                                                                                model: _model.conversationDeepakModel1,
                                                                                                updateCallback: () => safeSetState(() {}),
                                                                                                child: ConversationDeepakWidget(),
                                                                                              ),
                                                                                            ],
                                                                                          );
                                                                                        }
                                                                                          ...
                                                                                          if (_model.selectedIndex == 1) {
                                                                                            ...
                                                                                            return Column(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                wrapWithModel(
                                                                                                  model: _model.deepakAISummaryModel2,
                                                                                                  updateCallback: () => safeSetState(() {}),
                                                                                                  child: DeepakAISummaryWidget(),
                                                                                                ),
                                                                                              ],
                                                                                            ...
                                                                                            return Column(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                wrapWithModel(
                                                                                                  model: _model.conversationDeepakModel2,
                                                                                                  updateCallback: () => safeSetState(() {}),
                                                                                                  child: ConversationDeepakWidget(),
                                                                                                ),
                                                                                              ],
