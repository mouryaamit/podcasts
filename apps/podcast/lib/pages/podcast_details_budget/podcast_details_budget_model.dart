...
class PodcastDetailsBudgetModel
  ...
  // Model for YoutubePlayerBudget component.
  late YoutubePlayerBudgetModel youtubePlayerBudgetModel;
  ...
  void initState(BuildContext context) {
    youtubePlayerBudgetModel =
        createModel(context, () => YoutubePlayerBudgetModel());
  ...
  @override
  void dispose() {
    youtubePlayerBudgetModel.dispose();
