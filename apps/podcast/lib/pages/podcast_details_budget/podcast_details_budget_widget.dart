...
import '/components/youtube_player_budget_widget.dart';
...
import 'podcast_details_budget_model.dart';
export 'podcast_details_budget_model.dart';

class PodcastDetailsBudgetWidget extends StatefulWidget {
  const PodcastDetailsBudgetWidget({super.key});

  static String routeName = 'PodcastDetailsBudget';
  static String routePath = '/podcastDetailsBudget';

  @override
  State<PodcastDetailsBudgetWidget> createState() =>
      _PodcastDetailsBudgetWidgetState();
}

class _PodcastDetailsBudgetWidgetState
    extends State<PodcastDetailsBudgetWidget> {
  late PodcastDetailsBudgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PodcastDetailsBudgetModel());
                                      ...
                                      Expanded(
                                        child: ClipRRect(
                                          ...
                                          child: Container(
                                            ...
                                            child: wrapWithModel(
                                              model: _model
                                                  .youtubePlayerBudgetModel,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child:
                                                  YoutubePlayerBudgetWidget(),
                                            ),
                                          ),
                                        ),
                                      ),
                                    ...
                                    Padding(
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        child: SpeakerWidget(
                                          image:
                                              'https://storage.googleapis.com/flutterflow-enterprise-india.appspot.com/projects/e8gprS0m5G3loKTVCTdm/assets/hfb06ocb5a4r/srivats_img.png',
                                          name: 'Mr. Unnikrishnan Kottekkat',
                                          description:
