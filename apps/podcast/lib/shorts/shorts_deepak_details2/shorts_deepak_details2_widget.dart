...
import 'shorts_deepak_details2_model.dart';
export 'shorts_deepak_details2_model.dart';

class ShortsDeepakDetails2Widget extends StatefulWidget {
  const ShortsDeepakDetails2Widget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsDeepakDetails2Widget> createState() =>
      _ShortsDeepakDetails2WidgetState();
}

class _ShortsDeepakDetails2WidgetState
    extends State<ShortsDeepakDetails2Widget> {
  late ShortsDeepakDetails2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsDeepakDetails2Model());
