...
import 'shorts_srivats_model.dart';
export 'shorts_srivats_model.dart';

class ShortsSrivatsWidget extends StatefulWidget {
  const ShortsSrivatsWidget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsSrivatsWidget> createState() => _ShortsSrivatsWidgetState();
}

class _ShortsSrivatsWidgetState extends State<ShortsSrivatsWidget> {
  late ShortsSrivatsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsSrivatsModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(),
                          child: Text(
                            'MSME Conversations • October 2025 • 1.31 min',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
                              ...
                              Builder(
                                builder: (context) => Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      await Share.share(
                                        'https://youtu.be/LpOLpSboZUw?si=_nULVURWxCtF_JJG',
                                        sharePositionOrigin:
