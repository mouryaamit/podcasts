...
import 'shorts_budget_special_model.dart';
export 'shorts_budget_special_model.dart';

class ShortsBudgetSpecialWidget extends StatefulWidget {
  const ShortsBudgetSpecialWidget({
    super.key,
  ...
  @override
  State<ShortsBudgetSpecialWidget> createState() =>
      _ShortsBudgetSpecialWidgetState();
}

class _ShortsBudgetSpecialWidgetState extends State<ShortsBudgetSpecialWidget> {
  late ShortsBudgetSpecialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsBudgetSpecialModel());
