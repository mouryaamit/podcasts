...
import 'shorts_deepak_details1_model.dart';
export 'shorts_deepak_details1_model.dart';

class ShortsDeepakDetails1Widget extends StatefulWidget {
  const ShortsDeepakDetails1Widget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsDeepakDetails1Widget> createState() =>
      _ShortsDeepakDetails1WidgetState();
}

class _ShortsDeepakDetails1WidgetState
    extends State<ShortsDeepakDetails1Widget> {
  late ShortsDeepakDetails1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsDeepakDetails1Model());
