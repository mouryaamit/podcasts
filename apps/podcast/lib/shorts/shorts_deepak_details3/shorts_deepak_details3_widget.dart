...
import 'shorts_deepak_details3_model.dart';
export 'shorts_deepak_details3_model.dart';

class ShortsDeepakDetails3Widget extends StatefulWidget {
  const ShortsDeepakDetails3Widget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsDeepakDetails3Widget> createState() =>
      _ShortsDeepakDetails3WidgetState();
}

class _ShortsDeepakDetails3WidgetState
    extends State<ShortsDeepakDetails3Widget> {
  late ShortsDeepakDetails3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsDeepakDetails3Model());
