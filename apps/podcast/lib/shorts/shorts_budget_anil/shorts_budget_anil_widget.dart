...
import 'shorts_budget_anil_model.dart';
export 'shorts_budget_anil_model.dart';

class ShortsBudgetAnilWidget extends StatefulWidget {
  const ShortsBudgetAnilWidget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsBudgetAnilWidget> createState() => _ShortsBudgetAnilWidgetState();
}

class _ShortsBudgetAnilWidgetState extends State<ShortsBudgetAnilWidget> {
  late ShortsBudgetAnilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsBudgetAnilModel());
                              ...
                              Builder(
                                builder: (context) => Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      await Share.share(
                                        'https://youtu.be/270f2erlmyM?si=JssxNzz7ZFWDi5X9',
                                        sharePositionOrigin:
