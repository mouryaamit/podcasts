...
import 'videos_content4_model.dart';
export 'videos_content4_model.dart';

class VideosContent4Widget extends StatefulWidget {
  const VideosContent4Widget({super.key});

  @override
  State<VideosContent4Widget> createState() => _VideosContent4WidgetState();
}

class _VideosContent4WidgetState extends State<VideosContent4Widget> {
  late VideosContent4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideosContent4Model());
