...
import 'videos_content1_model.dart';
export 'videos_content1_model.dart';

class VideosContent1Widget extends StatefulWidget {
  const VideosContent1Widget({super.key});

  @override
  State<VideosContent1Widget> createState() => _VideosContent1WidgetState();
}

class _VideosContent1WidgetState extends State<VideosContent1Widget> {
  late VideosContent1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideosContent1Model());
