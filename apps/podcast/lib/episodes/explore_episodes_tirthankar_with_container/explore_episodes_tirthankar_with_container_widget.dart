                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  key:
                                      ValueKey('exploreEpisode_Tirthankar_web'),
                                  'assets/images/Tirthankar_explore_webp.webp',
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(),
                                    child: Text(
                                      'How MSMEs, Retail Investors & Smarter IPOs Are Reshaping Capital Markets',
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 10.0, 0.0, 0.0),
                                    child: Text(
                                      'India\'s capital markets are undergoing a transformation...',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                            ...
                            Padding(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  Text(
                                    'MSME Conversations • January 2026 • 30 min',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(6.0),
                                child: Image.asset(
                                  key: ValueKey('exploreEpisodes_Tirthankar_m'),
                                  'assets/images/Tirthankar_explore_webp.webp',
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                                      MediaQuery.sizeOf(context).height * 1.0,
