                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(12.0),
                                child: Image.asset(
                                  key: ValueKey('exploreEpisode_srivats_web'),
                                  'assets/images/Srivats_explore_webp.webp',
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 10.0, 0.0, 0.0),
                                    child: Text(
                                      'The numbers look promising. RBI upgraded GDP outlook to 6.8%…',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                            ...
                            Padding(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  Text(
                                    'MSME Conversations •  October 2025 • 37 min',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(6.0),
                                child: Image.asset(
                                  key: ValueKey('exploreEpisodes_srivats_m'),
                                  'assets/images/Srivats_explore_webp.webp',
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                                      MediaQuery.sizeOf(context).height * 1.0,
