...
import 'shorts_zeenat_details1_model.dart';
export 'shorts_zeenat_details1_model.dart';

class ShortsZeenatDetails1Widget extends StatefulWidget {
  const ShortsZeenatDetails1Widget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsZeenatDetails1Widget> createState() =>
      _ShortsZeenatDetails1WidgetState();
}

class _ShortsZeenatDetails1WidgetState
    extends State<ShortsZeenatDetails1Widget> {
  late ShortsZeenatDetails1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsZeenatDetails1Model());
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              ...
                              'assets/images/shorts_zeenat_details1_thumbnail.png',
                              width: MediaQuery.sizeOf(context).width * 1.0,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(),
                            child: Text(
                              'MSME Conversations • July 2025 • 1.52 min',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
