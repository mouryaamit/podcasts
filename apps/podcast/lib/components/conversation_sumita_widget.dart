...
import 'conversation_sumita_model.dart';
export 'conversation_sumita_model.dart';

class ConversationSumitaWidget extends StatefulWidget {
  const ConversationSumitaWidget({super.key});

  @override
  State<ConversationSumitaWidget> createState() =>
      _ConversationSumitaWidgetState();
}

class _ConversationSumitaWidgetState extends State<ConversationSumitaWidget> {
  late ConversationSumitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConversationSumitaModel());
