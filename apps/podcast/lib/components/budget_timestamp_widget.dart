...
class BudgetTimestampWidget extends StatefulWidget {
  const BudgetTimestampWidget({super.key});

  @override
  State<BudgetTimestampWidget> createState() => _BudgetTimestampWidgetState();
}

class _BudgetTimestampWidgetState extends State<BudgetTimestampWidget> {
  late BudgetTimestampModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BudgetTimestampModel());
