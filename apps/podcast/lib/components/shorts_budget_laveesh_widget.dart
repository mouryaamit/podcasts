...
import 'shorts_budget_laveesh_model.dart';
export 'shorts_budget_laveesh_model.dart';

class ShortsBudgetLaveeshWidget extends StatefulWidget {
  const ShortsBudgetLaveeshWidget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsBudgetLaveeshWidget> createState() =>
      _ShortsBudgetLaveeshWidgetState();
}

class _ShortsBudgetLaveeshWidgetState extends State<ShortsBudgetLaveeshWidget> {
  late ShortsBudgetLaveeshModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsBudgetLaveeshModel());
                              ...
                              Builder(
                                builder: (context) => Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      await Share.share(
                                        'https://youtu.be/oQfrtpOHFJE?si=H_9ht5Uy59A0FXoT',
                                        sharePositionOrigin:
