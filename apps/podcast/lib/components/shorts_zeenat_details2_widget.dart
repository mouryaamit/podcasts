...
import 'shorts_zeenat_details2_model.dart';
export 'shorts_zeenat_details2_model.dart';

class ShortsZeenatDetails2Widget extends StatefulWidget {
  const ShortsZeenatDetails2Widget({
    super.key,
    required this.share,
  ...
  @override
  State<ShortsZeenatDetails2Widget> createState() =>
      _ShortsZeenatDetails2WidgetState();
}

class _ShortsZeenatDetails2WidgetState
    extends State<ShortsZeenatDetails2Widget> {
  late ShortsZeenatDetails2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShortsZeenatDetails2Model());
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/shorts_zeenat_details2_img.png',
