...
import 'sumita_a_i_summary_model.dart';
export 'sumita_a_i_summary_model.dart';

class SumitaAISummaryWidget extends StatefulWidget {
  const SumitaAISummaryWidget({super.key});

  @override
  State<SumitaAISummaryWidget> createState() => _SumitaAISummaryWidgetState();
}

class _SumitaAISummaryWidgetState extends State<SumitaAISummaryWidget> {
  late SumitaAISummaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SumitaAISummaryModel());
