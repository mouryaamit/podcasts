...
import 'youtube_player_rahul_model.dart';
export 'youtube_player_rahul_model.dart';

class YoutubePlayerRahulWidget extends StatefulWidget {
  const YoutubePlayerRahulWidget({super.key});

  @override
  State<YoutubePlayerRahulWidget> createState() =>
      _YoutubePlayerRahulWidgetState();
}

class _YoutubePlayerRahulWidgetState extends State<YoutubePlayerRahulWidget> {
  late YoutubePlayerRahulModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YoutubePlayerRahulModel());
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) => FFButtonWidget(
                          onPressed: () async {
                            await Share.share(
                              'https://youtu.be/xAnDzidUwGU?si=iG7T7OL02Ck00o9A',
                              sharePositionOrigin:
